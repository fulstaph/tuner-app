...
enum ToneGenerator {
    static func makeClickBuffer(frequency: Float, duration: Double, sampleRate: Double = 44100, gain: Float = 1.0) -> AVAudioPCMBuffer {
        ...
        for i in 0..<frameCount {
            ...
            let wave = sinf(phase) + 0.3 * sinf(phase * 2) + 0.15 * sinf(phase * 3)
            ...
            if i < attackSamples {
                ...
                let decayProgress = Float(i - attackSamples - sustainSamples) / Float(frameCount - attackSamples - sustainSamples)
